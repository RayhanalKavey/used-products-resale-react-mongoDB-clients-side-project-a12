...
const Spinner = () => {
  return (
    <div className="flex justify-center items-center h-full bg-slate-200 py-10">
      <div>
        <div className="w-8 h-8 relative border-4 border-separate rounded-full animate-spin   border-purple-700">
          {" "}
